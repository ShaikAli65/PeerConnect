...
class Nomad:
    ...
    def __acceptConnection(self):
        try:
            ...
            self.selector.register(_conn, selectors.EVENT_READ, self.connectNew)
    ...
    def end(self):
        NOMAD_FLAG.set()
        self.currently_in_connection = self.currently_in_connection.fromkeys(self.currently_in_connection, False)
